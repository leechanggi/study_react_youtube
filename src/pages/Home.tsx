...
const items: IItem[] = [
	{
		...
		snippet: {
			...
			description: 'Включайте «Утро на Дожде» в 9.00 Мск! В эфире Денис Катаев и Полина Милушкова. В этом выпуске: Накануне курс ...',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			description: "Listen to Jake's new album, “Loose Cannon” now: https://jakeowen.lnk.to/LooseCannon Stay connected for exclusive updates: ...",
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			description: 'Welcome to our YouTube channel, where we bring you expert insights and valuable information on various foot-related issues.',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			title: 'Einfach Ingwerwurzel in kochende Milch geben! Sie werden erstaunt sein! 5-Minuten-Rezept',
			description: 'Leckeren Ingwer- und Milchkäse zuzubereiten ist einfach, und jetzt lernst du, wie es geht! Wir zeigen Ihnen ein Rezept, das ...',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			title: 'Beal $251M! Jokic $264M Richest NBA History! Lakers Lose Monk! PJ Tucker 76ers! 2022 NBA Free Agency',
			description: 'Splash the like button for more NBA videos! Follow On Twitch! https://www.twitch.tv/chris_smoove/ New Splash Crewneck/Shirt ...',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			description: '여러분 안녕하세요 삐맨입니다 오늘은 21년도 마블 영화와 드라마 전체를 세계관 내 시간 순서대로 총정리 해보려고 합니다. 재밌게 ...',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			description: 'Elevate your writing with 20% off Grammarly Premium by signing up at http://www.Grammarly.com/WHATIF Jetpack technology is ...',
			thumbnails: {
				default: {
	...
	},
	{
		...
		snippet: {
			...
			description: '이거 진짜 고소하고 너무 맛잇더라고요. 이건 너무 쉬워서 블로그가 없습니다. 시청해 주셔서 감사합니다. #까르보나라 #계란치즈 ...',
			thumbnails: {
				default: {
